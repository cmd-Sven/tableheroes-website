...
export const WIKI_HEADING_CLASS = {
  ...
  h2: "font-barlow font-bold text-2xl text-accent-blood border-b border-hero-border/70 pb-2 mt-7 mb-3 first:mt-0 scroll-mt-24",
...
export const WIKI_HEADING_PROSE_CLASSES = [
  ...
  "prose-h2:font-barlow prose-h2:font-bold prose-h2:text-2xl prose-h2:text-accent-blood",
