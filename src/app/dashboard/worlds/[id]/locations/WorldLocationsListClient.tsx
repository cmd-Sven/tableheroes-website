...
import { Map, Plus, Search, Sparkles } from "lucide-react";
  ...
  return (
    <div className="rounded-lg border border-hero-dark bg-background-card p-6 space-y-6">
      ...
      <p className="font-libre text-sm text-gray-400">
        Geografische Orte dieser Welt (Städte, Regionen, Gebäude, …). Sichtbarkeit für Spieler steuerst du pro Kampagne im Tab „Welt & Lore“.
      </p>
      ...
      {filteredLocations.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="font-cinzel text-lg text-accent-gold mb-2">
            {locations.length === 0 ? "Noch keine Orte" : "Keine Treffer"}
          </p>
          <p className="font-libre text-sm text-gray-400 mb-4">
            {locations.length === 0
              ? "Lege den ersten Ort an (z. B. Stadt, Region, Gebäude)."
