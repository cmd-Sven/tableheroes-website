/**
 * world-npc-actions — part 1: buildBlueprintContext, loadWorldAndAuth, generateNPC, generateNPCForWorld, regenerateNPCSection, generateNPCRelation, generateNPCFactionRelation, GenerateNPCOptions, GeneratedNPCResult, RerollSection, NPCRelationSuggestion, NPCFactionRelationSuggestion, BriefingMapping, BriefingNewEntity, ProcessBriefingResult.
 */
"use server";
