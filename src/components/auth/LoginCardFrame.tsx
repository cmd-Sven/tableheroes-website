  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/border_left-right_gold.png')",
      ...
      <div
        ...
        style={{ backgroundImage: "url('/images/corner-dragon-only.png')" }}
      />
      <div
        className="absolute bottom-0 left-0 z-10 h-[62px] w-[62px] bg-cover bg-no-repeat"
        style={{ backgroundImage: "url('/images/corner-claw-only.png')" }}
      />
      <div
        className="absolute top-0 right-0 z-10 h-[62px] w-[62px] scale-y-[-1] bg-cover bg-no-repeat"
        style={{ backgroundImage: "url('/images/skull-corner-only.png')" }}
      />
      <div
