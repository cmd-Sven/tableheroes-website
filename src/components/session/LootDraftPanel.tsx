...
import { Gift, Loader2, Plus, Sparkles, XCircle } from "lucide-react";
import { LootDraftPublishSection } from "./LootDraftPublishSection";
...
import {
  type DraftItem,
  shopRowToDraftItem,
  suggestionToDraftItems,
} from "./loot-draft-panel.utils";
