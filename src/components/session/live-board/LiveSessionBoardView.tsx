...
import { DungeonMasterCamRemote } from "@/src/components/session/DungeonMasterCamRemote";
import { DungeonMasterCamWebRtcSync } from "@/src/components/session/DungeonMasterCamWebRtcSync";
import { PlayerAvatarCamSessionProvider } from "@/src/components/session/PlayerAvatarCamSessionProvider";
import { LiveSessionWebcamProvider } from "@/src/components/session/LiveSessionWebcamProvider";
      ...
      <PlayerAvatarCamSessionProvider userId={userId} liveChannelRef={liveChannelRef}>
        <DungeonMasterCamProvider enabled={isGM} userId={userId}>
          ...
          >
            ...
            {isGM ? (
              <>
                <DungeonMasterCamWebRtcSync userId={userId} />
                <DungeonMasterCam />
              </>
            ) : (
              <DungeonMasterCamRemote />
            )}
          </div>
