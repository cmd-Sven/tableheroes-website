-- ensure_session_prep_live_state: INSERT mit allen NOT NULL-Spalten (Fate/Downtime/Anwesenheit/Truhe/Dummies),
-- damit Anlage unter RLS nicht an fehlenden Werten scheitert.
...
COMMENT ON FUNCTION public.ensure_session_prep_live_state(uuid) IS
  'Legt session_live_states für SL/Vorbereitung an (RLS-robust). INSERT inkl. Fate/Downtime/Truhe/Dummies.';
