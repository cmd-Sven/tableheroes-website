...
GRANT EXECUTE ON FUNCTION public.user_is_world_gm(uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.user_can_access_world_maps(uuid) TO authenticated;
